...
public class DataInitializationSessionBean {
    ...
    private void initializeData() {
        ...
        patientEntityControllerLocal.createNewPatient(new PatientEntity(1l, "Tony", "Teo", "M", "123", 44, "S7483027A", "87297373", "11 Tampines Ave 3"));
        patientEntityControllerLocal.createNewPatient(new PatientEntity(2l, "Wendy", "Tan", "F", "321", 35, "S8381028X", "97502837", "15 Computing Dr"));
...
//        /* // test adding consultation
        Calendar cal = Calendar.getInstance(); // this is 
